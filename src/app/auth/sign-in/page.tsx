        ...
        <div className="p-8 pb-6">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              />
              {errors.email && <p className="text-xs text-distructive">{errors.email.message}</p>}
            </div>
            ...
            <div className="space-y-0.5">
              ...
              />
              {errors.password && (
                <p className="text-xs text-distructive">{errors.password.message}</p>
              )}
            </div>
            {errors.root && (
              <p className="text-xs text-distructive text-center">{errors.root.message}</p>
            )}
